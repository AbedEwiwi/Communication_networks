...
This file represents the fat tree topolgy we used in Part 3 of the Project.
"""
...
class FatTreeTopology( Topo ):
    ...
    def __init__( self ):
        ...
        edges = [   Edge(switches[0],   switches[2]),
                    Edge(switches[0],   switches[4]),
                    Edge(switches[1],   switches[3]),
                    Edge(switches[1],   switches[5]),
                    Edge(switches[2],   switches[6]),
                    Edge(switches[2],   switches[7]),
                    Edge(switches[3],   switches[6]),
                    Edge(switches[3],   switches[7]),
                    Edge(switches[4],   switches[8]),
                    Edge(switches[4],   switches[9]),
                    Edge(switches[5],   switches[8]),
                    Edge(switches[5],   switches[9]),
                    Edge(hosts[0],      switches[6]), 
                    Edge(hosts[1],      switches[6]), 
                    Edge(hosts[2],      switches[7]),
                    Edge(hosts[3],      switches[7]),
                    Edge(hosts[4],      switches[8]),
                    Edge(hosts[5],      switches[8]),
                    Edge(hosts[6],      switches[9]),
                    Edge(hosts[7],      switches[9]),
                    Edge(hosts[8],      switches[9])
            ]
